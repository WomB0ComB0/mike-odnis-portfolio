      ...
      <div class="bg-zinc-900 rounded-lg p-6 hover:-translate-y-2 transition-transform duration-300 border border-zinc-800 hover:border-emerald-400/50 flex flex-col h-full fade-in">
        <div class="flex justify-between items-start mb-4">
          ...
          <div class="flex space-x-4">
            ${p.githubUrl ? `<a href="${p.githubUrl}" target="_blank" rel="noopener noreferrer" class="text-zinc-400 hover:text-emerald-400 transition-colors"><i data-lucide="github" class="w-5 h-5"></i></a>` : ''}
            ${p.liveUrl && p.liveUrl !== 'N/A' ? `<a href="${p.liveUrl}" target="_blank" rel="noopener noreferrer" class="text-zinc-400 hover:text-emerald-400 transition-colors"><i data-lucide="external-link" class="w-5 h-5"></i></a>` : ''}
          </div>
        </div>
